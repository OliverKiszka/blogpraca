...
<body>
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<div class="navbar-nav">
			...
			<a href="o_mnie.php" class="nav-item nav-link active">O mnie</a>
	...
	<div class="pudelko">
		<div class="powitanie"> <h1>Niniejsza aplikacja powstała w ramach pracy inżynierskiej realizowanej na koniec studiów w Zachodniopomorskim Uniwersytecie Technologicznym</h1>
		</div>
		<div class="powitanie"> <h2>Temat pracy: „Zaprojektowanie i implementacja strony internetowej do
zarządzania księgowością sezonowych sklepów nadmorskich,
z użyciem programowania w językach javascript, php" </h2>
		</div>
		<div class="powitanie"> <h2>Promotor: dr Joanna Banaś</h2>
		</div>
		<div class="powitanie"> <h2>Autor aplikacji: Oliwer Kiszka</h2>
		</div>
	</div>
